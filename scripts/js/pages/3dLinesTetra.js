...
LinesTetra.prototype.draw = function() { 
    ...
    gl.uniform3f( uNormal, 1, 1, 1 );
    gl.uniform1i( uLit, 0 );  // The lines representing the coordinate axes are not lit.

    gl.lineWidth(1);
    LinesTetra.prototype.drawPrimitive(gl.LINES, [0, 0, 1, 1], [0, -0.7, -1, 0, 1, 0]);
    LinesTetra.prototype.drawPrimitive(gl.LINES, [0, 0, 1, 1], [0, 1, 0, -1, -0.7, 0.7]);
    LinesTetra.prototype.drawPrimitive(gl.LINES, [0, 0, 1, 1], [1, -0.7, 0.7, 0, 1, 0]);
    
    gl.lineWidth(5);

    LinesTetra.prototype.drawPrimitive(gl.LINES, [1, 0, 0, 1], [-1, -0.7, 0.7, 1, -0.7, 0.7]);
    LinesTetra.prototype.drawPrimitive(gl.LINES, [1, 0, 0, 1], [1, -0.7, 0.7, 0, -0.7, -1]);
    LinesTetra.prototype.drawPrimitive(gl.LINES, [1, 0, 0, 1], [-1, -0.7, 0.7, 0, -0.7, -1]);
    gl.lineWidth(5);
}
 ...
 */
LinesTetra.prototype.createProgram = function(gl, vertexShaderSource, fragmentShaderSource) {
